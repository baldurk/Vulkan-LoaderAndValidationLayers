...
class DescriptorSetLayout {
  public:
    ...
    bool HasBinding(const uint32_t binding) const { return binding_to_index_map_.count(binding); };
...
public:
    ...
    virtual bool GetClass() const { return descriptor_class; };
...
bool ValidateImageUpdate(const VkImageView, const VkImageLayout, const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *, std::string*);
//bool ValidateImageUpdate(const VkImageView, const VkImageLayout, const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *image_to_swapchain_map, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *swapchain_map, std::string *error) {
...
public:
    ImageSamplerDescriptor(const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *, const std::unordered_map<VkSampler, std::unique_ptr<SAMPLER_NODE>> *);
    ImageSamplerDescriptor(const VkSampler *, const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *, const std::unordered_map<VkSampler, std::unique_ptr<SAMPLER_NODE>> *);
    bool WriteUpdate(const VkWriteDescriptorSet *, const uint32_t, std::string *) override;
    bool CopyUpdate(const Descriptor*, std::string*) override;
private:
    VkSampler        sampler_;
...
public:
    ImageDescriptor(const VkDescriptorType, const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *);
    bool WriteUpdate(const VkWriteDescriptorSet *, const uint32_t, std::string *) override;
    bool CopyUpdate(const Descriptor*, std::string*) override;
...
public:
    TexelDescriptor(const VkDescriptorType, const std::unordered_map<VkBuffer, BUFFER_NODE> *, const std::unordered_map<VkDeviceMemory, DEVICE_MEM_INFO> *, const std::unordered_map<VkBufferView, VkBufferViewCreateInfo> *);
    bool WriteUpdate(const VkWriteDescriptorSet *, const uint32_t, std::string *) override;
    bool CopyUpdate(const Descriptor*, std::string*) override;
...
public:
    BufferDescriptor(const VkDescriptorType, const std::unordered_map<VkBuffer, BUFFER_NODE> *, const std::unordered_map<VkDeviceMemory, DEVICE_MEM_INFO> *);
    bool WriteUpdate(const VkWriteDescriptorSet *, const uint32_t, std::string *) override;
    bool CopyUpdate(const Descriptor*, std::string*) override;
...
// TODODS : Need to get maps of objects into here so I can validate them
class DescriptorSet {
  public:
    //DescriptorSet();
    DescriptorSet(const VkDescriptorSet, const DescriptorSetLayout*, const std::unordered_map<VkBuffer, BUFFER_NODE> *, const std::unordered_map<VkDeviceMemory, DEVICE_MEM_INFO> *, const std::unordered_map<VkBufferView, VkBufferViewCreateInfo> *, const std::unordered_map<VkSampler, std::unique_ptr<SAMPLER_NODE>> *, const std::unordered_map<VkImageView, VkImageViewCreateInfo> *, const std::unordered_map<VkImage, IMAGE_NODE> *, const std::unordered_map<VkImage, VkSwapchainKHR> *, const std::unordered_map<VkSwapchainKHR, SWAPCHAIN_NODE *> *);
    //DescriptorSet(const VkDescriptorSet, const DescriptorSetLayout*);
    ~DescriptorSet();
    ...
    VkDescriptorType GetTypeFromIndex(const uint32_t index) const { return p_layout_ ? p_layout_->GetTypeFromIndex(index) : VK_DESCRIPTOR_TYPE_MAX_ENUM; };
    VkDescriptorType GetTypeFromGlobalIndex(const uint32_t index) const { return p_layout_ ? p_layout_->GetTypeFromGlobalIndex(index) : VK_DESCRIPTOR_TYPE_MAX_ENUM; };
    uint32_t GetDescriptorCountFromIndex(const uint32_t index) const { return p_layout_ ? p_layout_->GetDescriptorCountFromIndex(index) : VK_DESCRIPTOR_TYPE_MAX_ENUM; };
    ...
    bool ValidateDrawState(const std::unordered_set<uint32_t> &, std::string *) const;
    // For given set of bindings, add any buffers and images that will be updated to their respective unordered_sets & return number of objects inserted
    uint32_t GetStorageUpdates(const std::unordered_set<uint32_t> &, std::unordered_set<VkBuffer> *, std::unordered_set<VkImageView> *) const;
    // For all descriptors in a set, add any buffers and images that may be updated to their respective unordered_sets & return number of objects inserted
    uint32_t GetAllStorageUpdates(std::unordered_set<VkBuffer> *, std::unordered_set<VkImageView> *) const;
    bool some_update; // has any part of the set ever been updated?
    bool full_update; // has every descriptor in the set been updated?
    ...
    bool IsUpdated() const { return some_update; };
